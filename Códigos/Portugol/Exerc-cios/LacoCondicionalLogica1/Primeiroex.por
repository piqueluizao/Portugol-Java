	...
	funcao inicio()
	{
		real P,E,M
			...
			leia(P)
				...
				se (P>50)
				{
					escreva("\nVocê passou do limite de peso estabelecido pelo regulamento de SP")
					escreva("\nVocê terá que pagar umas multa de R$4,00 por quilo excedente")
					E=P-50
					M=E*4
					escreva("\nA multa é de R$",M)
				}
				senao
				{
					escreva("\nVocê não precisará pagar nenhuma multa")
				}
	}
}
/* $$$ Portugol Studio $$$ 
